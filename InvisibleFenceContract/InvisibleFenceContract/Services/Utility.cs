...
namespace InvisibleFenceContract.Services
{
    public static class Utility
    {
        ...
        public static void InitialLoadOrderData()
        {
            ...
            Order.CustomerID = "";
            Order.PackageSelection = "GPS";
            Order.PackagePrice = 2999;
            Order.SafetyTotal = 2999;
            ...
            Order.InstallTotal = 500;
            Order.SolutionTotal = 4436;
            Order.TaxRate = .06;
            Order.Tax = 266.16;
            Order.Total = 5202.16;
            Order.Deposit = 0;
            Order.Balance = 5202.16;
